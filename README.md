...
| **2** | CAS storage engine, versioning, dedup, share links | **in progress** — slice 1 complete: uploads chunk through FastCDC+BLAKE3+zstd with cross-user dedup; versioning and share links next |
